      ...
      >
        ...
        >
            ...
            {NAV_ITEMS.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="relative z-10 group-hover:scale-105 inline-block transition-transform">{item.label}</span>
                </Link>
              );
            })}
          </nav>
          ...
          <div className="hidden lg:flex items-center gap-3 relative z-10">
            ...
            >
              {theme === Theme.LIGHT ? <Moon size={18} weight="regular" /> : <Sun size={18} weight="regular" />}
            </button>
          </div>
